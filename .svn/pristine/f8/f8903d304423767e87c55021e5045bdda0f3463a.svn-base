...
public class NearbyPubPopWindow {
	private final PopupWindow popupWindow;
	private Context mContext;
	private CheckBox[] checkBoxs;

	public NearbyPubPopWindow(Context mParent) {
	...
	private View initMenuView(Context mContext) {
		View menuView = View.inflate(mContext, R.layout.popwindow_nearby_pub,
				null);
		...
		checkBoxs = new CheckBox[] {
				(CheckBox) menuView.findViewById(R.id.ckbPubQing),
				(CheckBox) menuView.findViewById(R.id.ckbPubRock),
				(CheckBox) menuView.findViewById(R.id.ckbPubArts),
				(CheckBox) menuView.findViewById(R.id.ckbPubAll) };
