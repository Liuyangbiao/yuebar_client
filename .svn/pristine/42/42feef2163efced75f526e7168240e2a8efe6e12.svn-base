...
public class FriendListFragment extends BaseFragment implements
		OnItemClickListener {
	private static Fragment FriendListFragment;
	private View view;
	...
	private void initData() {
		...
		getContactList();
		lvfriendsList = (ListView) view.findViewById(R.id.lvfriendsList);
		friendsListAdapter = new FriendsListAdapter(getActivity(), listContact);
	...
	public void onItemClick(AdapterView<?> parent, View view,
		...
		System.out.println("传参：" + listContact.get(position).getUserMobile()
				+ "      " + listContact.get(position).getUserLogoUrl());
