...
public class NetworkManager {
	...
	private static int networkType = NETWORKTYPE_INVALID;
	...
	public static void checkNetwork() {
		LogUtil.printUserEntryLog("enter getNetWorkType");
		...
		LogUtil.printUserEntryLog("network type is:" + networkType);
	}
	...
	public static boolean isFastNetwork() {
		return (networkType == NETWORKTYPE_WIFI || networkType == NETWORKTYPE_3G);
	}
