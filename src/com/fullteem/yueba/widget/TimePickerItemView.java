 ...
 * 
 */
public class TimePickerItemView extends View {
	/** Scrolling duration */
	...
	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF7e7e7e;

	/** Top and bottom shadows colors */
	private static final int[] TOP_SHADOW_COLORS = new int[] { 0xff9dd8ee,
			0xfff5f5f5, 0xfff5f5f5 };
	private static final int[] BOTTOM_SHADOW_COLORS = new int[] { 0xfFdedede,
			0xfff5f5f5, 0xfff5f5f5 };
	 ...
	 * Constructor
	 */
	public TimePickerItemView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public TimePickerItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	...
	private void drawShadows(Canvas canvas) {
		...
		topShadow.setSize(getWidth(), 20);
		topShadow.draw(canvas);

		bottomShadow.setBounds(0, getHeight() - getHeight() / visibleItems,
				getWidth(), getHeight());
		bottomShadow.setSize(getWidth(), 20);
	...
	public interface OnWheelScrollListener {
		 ...
		 */
		void onScrollingStarted(TimePickerItemView wheel);
		 ...
		 *            the wheel view whose state has changed.
		 */
		void onScrollingFinished(TimePickerItemView wheel);
	}
	...
	public interface OnWheelChangedListener {
		 ...
		 */
		void onChanged(TimePickerItemView wheel, int oldValue, int newValue);
	}
